    ...
    domain::{
        ...
        trident::{
            ...
            ports::{
                ...
                PasskeyAuthenticateInput, PasskeyAuthenticateOutput,
...
impl<CR, RC, AS, H, URA, ML, UR, RR, ES, SC, PRT, SE, WH, ETR, TR, PPR, WCR>
    TridentServiceImpl<CR, RC, AS, H, URA, ML, UR, RR, ES, SC, PRT, SE, WH, ETR, TR, PPR, WCR>
where
    CR: CredentialRepository,
    RC: RecoveryCodeRepository,
    AS: AuthSessionRepository,
...
impl<CR, RC, AS, H, URA, ML, UR, RR, ES, SC, PRT, SE, WH, ETR, TR, PPR, WCR> TridentService
    for TridentServiceImpl<CR, RC, AS, H, URA, ML, UR, RR, ES, SC, PRT, SE, WH, ETR, TR, PPR, WCR>
where
    CR: CredentialRepository,
    RC: RecoveryCodeRepository,
    AS: AuthSessionRepository,
